 ...
 * @author Asus
 */
public class CommandArguments extends Statement implements Iterable<CodeFragmentList>
{
    ...
    @Override
    public final CodeFragmentType getCodeFragmentType() { return CodeFragmentType.COMMAND_ARGUMENTS; }
