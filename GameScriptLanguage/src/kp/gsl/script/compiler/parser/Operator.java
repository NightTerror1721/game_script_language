 ...
 * @author Asus
 */
public abstract class Operator extends RawCode
{
    ...
    @Override
    public final CodeFragmentType getCodeFragmentType() { return CodeFragmentType.OPERATOR; }
    ...
    public static final Operator
            ...
            CAST_BOOLEAN = new UnaryOperator(OperatorSymbol.CAST_BOOLEAN),
            CAST_STRING = new UnaryOperator(OperatorSymbol.CAST_STRING),
            CAST_CONST_TUPLE = new UnaryOperator(OperatorSymbol.CAST_CONST_TUPLE),
            CAST_CONST_MAP = new UnaryOperator(OperatorSymbol.CAST_CONST_TUPLE),
            CAST_FUNCTION = new UnaryOperator(OperatorSymbol.CAST_FUNCTION),
            CAST_LIST = new UnaryOperator(OperatorSymbol.CAST_LIST),
            CAST_TUPLE = new UnaryOperator(OperatorSymbol.CAST_TUPLE),
            CAST_MAP = new UnaryOperator(OperatorSymbol.CAST_MAP),
            CAST_STRUCT = new UnaryOperator(OperatorSymbol.CAST_STRUCT),
            CAST_BLUEPRINT = new UnaryOperator(OperatorSymbol.CAST_BLUEPRINT),
            CAST_OBJECT = new UnaryOperator(OperatorSymbol.CAST_OBJECT),
            CAST_ITERATOR = new UnaryOperator(OperatorSymbol.CAST_ITERATOR),
            CAST_BYTES = new UnaryOperator(OperatorSymbol.CAST_BYTES),
            CAST_NATIVE = new UnaryOperator(OperatorSymbol.CAST_NATIVE),
            ...
            CLASS = new UnaryOperator(OperatorSymbol.CLASS),
    ...
    private static class PeekOperator extends Operator
    {
        public PeekOperator()
        {
            super(OperatorSymbol.PEEK);
        }
