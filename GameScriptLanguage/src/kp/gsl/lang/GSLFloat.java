...
public final class GSLFloat extends GSLImmutableValue
{
    ...
    @Override public final GSLImmutableValue operatorNegate() { return number == 0d ? TRUE : FALSE; }
    ...
    @Override public final GSLImmutableValue operatorRemainder(GSLValue value) { return new GSLInteger((long) number % value.longValue()); }
    @Override public final GSLImmutableValue operatorIncrease() { return new GSLFloat(number + 1); }
    @Override public final GSLImmutableValue operatorDecrease() { return new GSLFloat(number - 1); }
    @Override public final GSLImmutableValue operatorNegative() { return new GSLFloat(-number); }

    @Override public final GSLImmutableValue operatorBitwiseShiftLeft(GSLValue value) { return new GSLInteger((long) number >> value.longValue()); }
    @Override public final GSLImmutableValue operatorBitwiseShiftRight(GSLValue value) { return new GSLInteger((long) number << value.longValue()); }
    @Override public final GSLImmutableValue operatorBitwiseAnd(GSLValue value) { return new GSLInteger((long) number & value.longValue()); }
    @Override public final GSLImmutableValue operatorBitwiseOr(GSLValue value) { return new GSLInteger((long) number | value.longValue()); }
    @Override public final GSLImmutableValue operatorBitwiseXor(GSLValue value) { return new GSLInteger((long) number ^ value.longValue()); }
    @Override public final GSLImmutableValue operatorBitwiseNot() { return new GSLInteger(~((long) number)); }

    @Override public final GSLImmutableValue operatorGet(GSLValue index) { throw new UnsupportedOperatorException(this, "[]"); }
